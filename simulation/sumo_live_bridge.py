    ...
    def start(self):
        ...
        try:
            while self.is_running:
                ...
                # SN-002: a periodic publisher previously emitted
                # "MARL Green Extension +4.0s (Junction X)" to signal_events every
                # 15 steps, regardless of state and with no model involved. The
                # dashboard displayed that string as an AI decision.
                #
