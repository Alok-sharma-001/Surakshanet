...
from sqlalchemy import Column, Float, DateTime, ForeignKey, JSON, String, PrimaryKeyConstraint
...
class TrafficReading(Base):
    ...
    timestamp = Column(DateTime, primary_key=True, default=datetime.utcnow, index=True, nullable=False)
