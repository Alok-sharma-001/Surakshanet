...
**Progress:** 0 / 150 DONE — **0%** *(update on every change; baseline at audit time was 42% overall project completion)*

| Phase | Tasks | Done |
|---|---|---|
| 0 Cleanup | SN-001 … SN-012 | 0/12 |
...
**Component** ML API · **Priority** P0 · **Depends** — · **Status** `NOT_STARTED`
...
**Component** SUMO bridge · **Priority** P0 · **Depends** — · **Status** `NOT_STARTED`
...
**Component** ML API · **Priority** P0 · **Depends** SN-001 · **Status** `NOT_STARTED`
...
**Component** Frontend · **Priority** P0 · **Depends** — · **Status** `NOT_STARTED`
...
**Component** Simulation API · **Priority** P0 · **Depends** — · **Status** `NOT_STARTED`
...
**Component** ML API · **Priority** P0 · **Depends** SN-006 · **Status** `NOT_STARTED`
...
**Component** Shared / schemas · **Priority** P0 · **Depends** — · **Status** `NOT_STARTED`
...
**Component** Frontend · **Priority** P0 · **Depends** SN-008 · **Status** `NOT_STARTED`
...
**Component** Routing · **Priority** P1 · **Depends** — · **Status** `NOT_STARTED`
...
**Component** Docs · **Priority** P0 · **Depends** SN-001…SN-010 · **Status** `NOT_STARTED`
...
**Component** Docs · **Priority** P1 · **Depends** SN-011 · **Status** `NOT_STARTED`
